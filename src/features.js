      ...
      '<div class="modal-body">' +
        '<div class="form-row" style="margin-bottom:14px">' +
          '<div class="field"><label>Patient Name <span>*</span></label>' +
            '<input type="text" id="bk_patientName" placeholder="Full name" list="bk_patList" autocomplete="off">' +
            '<datalist id="bk_patList">'+patOpts+'</datalist></div>' +
          '<div class="field"><label>Phone</label>' +
            '<input type="tel" id="bk_phone" placeholder="Mobile number"></div>' +
        '</div>' +
        '<div class="form-row" style="margin-bottom:14px">' +
          '<div class="field"><label>Doctor</label>' +
            '<select id="bk_doctor"><option value="">— Select Doctor —</option>'+docOpts+'</select></div>' +
        ...
        '</div>' +
        '<div class="form-row" style="margin-bottom:14px">' +
          '<div class="field"><label>Date <span>*</span></label>' +
            '<input type="date" id="bk_date" value="'+today+'" min="'+today+'" max="'+addDays(today,7)+'"></div>' +
        ...
        '<div class="field" style="margin-bottom:0">' +
          ...
          '<input type="text" id="bk_notes" placeholder="e.g. Fever for 3 days, routine check-up…"></div>' +
...
async function saveAppointment() {
  var name      = (document.getElementById('bk_patientName')?.value || '').trim();
  var date      = document.getElementById('bk_date')?.value      || todayISO();
  ...
  if (document.getElementById('apptDateFilter')) document.getElementById('apptDateFilter').value = date;
